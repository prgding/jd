<template>
  <el-dialog
    ...
    <el-form-item label="优惠券类型[0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券]" prop="couponType">
      <el-input v-model="dataForm.couponType" placeholder="优惠券类型[0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券]"></el-input>
    </el-form-item>
    <el-form-item label="优惠券图片" prop="couponImg">
      <el-input v-model="dataForm.couponImg" placeholder="优惠券图片"></el-input>
    </el-form-item>
    <el-form-item label="优惠券名字" prop="couponName">
      <el-input v-model="dataForm.couponName" placeholder="优惠券名字"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          couponType: [
            { required: true, message: '优惠券类型[0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券]不能为空', trigger: 'blur' }
          ],
          couponImg: [
